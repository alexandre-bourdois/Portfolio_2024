...
function Header() {
  ...
  return (
    <header
      className="border-b  max-h-screen border-b-hoverColor bg-bodyColor text-white/80
                        sticky top-0 z-50"
    >
              ...
              >
                ...
                <ul>
                  <div className="flex gap-4 mt-2 justify-center">
                    <Link
                      href="https://github.com/alexandre-bourdois"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Image
                    ...
                    <Link
                      href="https://www.linkedin.com/in/alexandre-bourdois/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Image
                    ...
                    <Link
                      href="https://www.malt.fr/profile/alexandrebourdois"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Image
                    ...
                    <Link
                      href="mailto:alexandrebourdoispro@gmail.com"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Image
